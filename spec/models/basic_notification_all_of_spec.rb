...
# Unit tests for OneSignal::BasicNotificationAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneSignal::BasicNotificationAllOf do
  let(:instance) { OneSignal::BasicNotificationAllOf.new }

  describe 'test an instance of BasicNotificationAllOf' do
    it 'should create an instance of BasicNotificationAllOf' do
      expect(instance).to be_instance_of(OneSignal::BasicNotificationAllOf)
    end
  end
