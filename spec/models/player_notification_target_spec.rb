...
# Unit tests for OneSignal::PlayerNotificationTarget
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OneSignal::PlayerNotificationTarget do
  let(:instance) { OneSignal::PlayerNotificationTarget.new }

  describe 'test an instance of PlayerNotificationTarget' do
    it 'should create an instance of PlayerNotificationTarget' do
      expect(instance).to be_instance_of(OneSignal::PlayerNotificationTarget)
    end
  end
