...
module OneSignal
  ...
  class NotificationAllOfAndroidBackgroundLayout
    ...
    attr_accessor :headings_color

    # Body text color ARGB Hex format. Example(Red) \"FFFF0000\".
    attr_accessor :contents_color
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'headings_color')
        self.headings_color = attributes[:'headings_color']
      end

      if attributes.key?(:'contents_color')
        self.contents_color = attributes[:'contents_color']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          image == o.image &&
          headings_color == o.headings_color &&
          contents_color == o.contents_color
    end
    ...
    def hash
      [image, headings_color, contents_color].hash
    end
