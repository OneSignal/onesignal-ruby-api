...
require 'onesignal/models/bad_request_error'
...
require 'onesignal/models/identify_user_conflict_response'
require 'onesignal/models/identify_user_conflict_response_errors_inner'
